...
- Value: IP address of your SCCM Distribution Point (e.g., <ADD-IP-ADDRESS>)
...
```
TFTP: <ADD-IP-ADDRESS>: request for SMSBoot\HLL00002\x64\BCD.
...
```
TFTP: <ADD-IP-ADDRESS>: request for SMSBoot\HLL00002\x64\BCD.
TFTP: <ADD-IP-ADDRESS>: cannot open SMSBoot\HLL00002\x64\BCD.
```
